export const translations = {
  gu: {
    ...
    clientLedger: 'ક્લાયન્ટ લેજર',
    selectClientToViewLedger: 'લેજર જોવા માટે ક્લાયન્ટ પસંદ કરો',
    totalTransactions: 'કુલ ટ્રાન્ઝેક્શન',
    grandTotal: 'કુલ સંખ્યા',
    downloadCompleteLedger: 'સંપૂર્ણ લેજર ડાઉનલોડ કરો',
    noTransactionsFound: 'આ ક્લાયન્ટ માટે કોઈ ટ્રાન્ઝેક્શન મળ્યું નથી',
    type: 'પ્રકાર',
    udhar: 'ઉધાર',
    jama: 'જમા',
  ...
  en: {
    ...
    selectClientToViewLedger: 'Select a client to view ledger',
    totalTransactions: 'Total Transactions',
    grandTotal: 'Grand Total',
    downloadCompleteLedger: 'Download Complete Ledger',
    noTransactionsFound: 'No transactions found for this client',
    type: 'Type',
    udhar: 'Udhar',
    jama: 'Jama',
    loading: 'Loading',
